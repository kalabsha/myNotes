...
> 本文出处：[极客时间 《Go 语言项目开发实战》课程补充教程](https://github.com/marmotedu/geekbang-go)，基于原作略有改动。

在 Go 项目开发中，一个好的编码规范可以极大的提高代码质量。为了帮你节省时间和精力，这里我整理了一份清晰、可直接套用的 Go 编码规范，供你参考。
...
- 当存在资源创建时，应紧跟 defer 释放资源(可以大胆使用 defer，defer 在 Go 1.14 版本中，性能大幅提升，defer 的性能损耗即使在性能敏感型的业务中，也可以忽略)。
